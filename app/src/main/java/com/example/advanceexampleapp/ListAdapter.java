...
//                holder.imgThumbnail.setVisibility(View.GONE);
                            ...
                            bundle.putString("videoPath",elements.get(position).getMediaVideo());
                            Fragment myFragment = new VideoviewFragment();
                            myFragment.setArguments(bundle);
                            activity.getSupportFragmentManager().beginTransaction().replace(R.id.fullscreen,myFragment).addToBackStack(null).commit();
